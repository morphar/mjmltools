...
const { isObject, findLastIndex, find } = tmp_lodash
import tmp_lodash_fp from 'lodash/fp.js'
const { filter, map, flow } = tmp_lodash_fp

import cleanNode from './helpers/cleanNode.js'
import convertBooleansOnAttrs from './helpers/convertBooleansOnAttrs.js'
import setEmptyAttributes from './helpers/setEmptyAttributes.js'
